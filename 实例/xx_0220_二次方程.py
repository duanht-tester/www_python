...
#     elif a == 0 and b != 0:
#         x = c/b
#         print('为一次方程式，x的结果为：%.2f' % (x))
#     elif a != 0 and b == 0:
#         d = -c/a
#         if d > 0:
#             x = math.sqrt(d)
#             print('为一次方程式， x 的结果为：%.2f' % (x))
#         else:
#             print("警告！该方程式无解。")
#     elif a != 0 and b != 0:
#         # 计算
...
#     x1 = (-b-sqrt(d))/(2*a)
#     x2 = (-b+sqrt(d))/(2*a)
#     print('x1和x2的值是{:.3f}和{:.3f}'.format(x1, x2))
# except ZeroDivisionError:
#     print('数字a不可能是零!')


# 写了个比较完整的一元二次方程判
# 断，实数根，复数根，提醒用户输入数字类数据......
import os
import math
import cmath
...
# 分享一个自己写的练习题，定义了两个函数来分别实现获取用户输入以及解方程的功能，
# 使得程序的可拓展性大大提高。代码如下：
...
# 综合上述笔记，自己写的练习题。考虑了特殊字符转换 float 的情况：
# def mx(a, b, c):
#     if a == 0:
#         if b == 0:
#             print("不是方程。")
